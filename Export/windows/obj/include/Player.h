...
class HXCPP_CLASS_ATTRIBUTES Player_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< Player_obj > __new(::hx::Null< int >  __o_assetID);
		static ::hx::ObjectPtr< Player_obj > __alloc(::hx::Ctx *_hx_ctx,::hx::Null< int >  __o_assetID);
