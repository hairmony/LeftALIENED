...
HXLINE( 164)		worker->run( ::Dynamic(new _hx_Closure_1(defaultPath1,title,worker,type1,filter)),null());
...
HXLINE( 270)		worker->run( ::Dynamic(new _hx_Closure_1(title,worker,filter,defaultPath)),null());
...
HXLINE( 333)		worker->run( ::Dynamic(new _hx_Closure_1(title,worker,filter,defaultPath)),null());
