...
HXLINE( 192)			::flixel::FlxG_obj::log->advanced(((HX_("FlxSlider: MinValue and MaxValue can't be the same (",b5,38,bb,84) + MinValue) + HX_(")",29,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/addons/ui/FlxSlider.hx",9d,0a,7a,92),192,HX_("flixel.addons.ui.FlxSlider",c2,8c,47,0b),HX_("new",60,d0,53,00)));
            		}
...
HXDLIN( 226)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXLINE( 275)		 ::flixel::FlxCamera camera = this->getCameras()->__get(0).StaticCast<  ::flixel::FlxCamera >();
HXLINE( 278)		int viewX = ::flixel::FlxG_obj::mouse->viewX;
HXLINE( 279)		int viewY = ::flixel::FlxG_obj::mouse->viewY;
HXLINE( 284)		if (::flixel::math::FlxMath_obj::pointInFlxRect(( (Float)(viewX) ),( (Float)(viewY) ),this->_bounds)) {
HXLINE( 286)			if ((this->hoverAlpha != 1)) {
HXLINE( 288)				this->set_alpha(this->hoverAlpha);
            			}
HXLINE( 292)			bool _hx_tmp;
HXDLIN( 292)			if (::hx::IsNotNull( this->hoverSound )) {
HXLINE( 292)				_hx_tmp = !(this->_justHovered);
            			}
            			else {
HXLINE( 292)				_hx_tmp = false;
            			}
HXDLIN( 292)			if (_hx_tmp) {
HXLINE( 294)				::flixel::FlxG_obj::sound->play(this->hoverSound,null(),null(),null(),null(),null());
            			}
HXLINE( 298)			this->_justHovered = true;
HXLINE( 300)			 ::flixel::input::mouse::FlxMouseButton _this = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 300)			bool _hx_tmp1;
HXDLIN( 300)			if ((_this->current != 1)) {
HXLINE( 300)				_hx_tmp1 = (_this->current == 2);
            			}
            			else {
HXLINE( 300)				_hx_tmp1 = true;
            			}
HXDLIN( 300)			if (_hx_tmp1) {
HXLINE( 302)				this->handle->set_x(( (Float)(viewX) ));
HXLINE( 303)				this->updateValue();
HXLINE( 306)				bool _hx_tmp2;
HXDLIN( 306)				if (::hx::IsNotNull( this->clickSound )) {
HXLINE( 306)					_hx_tmp2 = !(this->_justClicked);
            				}
            				else {
HXLINE( 306)					_hx_tmp2 = false;
            				}
HXDLIN( 306)				if (_hx_tmp2) {
HXLINE( 308)					::flixel::FlxG_obj::sound->play(this->clickSound,null(),null(),null(),null(),null());
HXLINE( 309)					this->_justClicked = true;
            				}
            			}
HXLINE( 313)			 ::flixel::input::mouse::FlxMouseButton _this1 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 313)			bool _hx_tmp3;
HXDLIN( 313)			if ((_this1->current != 1)) {
HXLINE( 313)				_hx_tmp3 = (_this1->current == 2);
            			}
            			else {
HXLINE( 313)				_hx_tmp3 = true;
            			}
HXDLIN( 313)			if (!(_hx_tmp3)) {
HXLINE( 315)				this->_justClicked = false;
            			}
            		}
            		else {
HXLINE( 320)			if ((this->hoverAlpha != 1)) {
HXLINE( 322)				this->set_alpha(( (Float)(1) ));
            			}
HXLINE( 325)			this->_justHovered = false;
            		}
HXLINE( 329)		bool _hx_tmp4;
HXDLIN( 329)		 ::flixel::input::mouse::FlxMouseButton _this2 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 329)		bool _hx_tmp5;
HXDLIN( 329)		if ((_this2->current != 1)) {
HXLINE( 329)			_hx_tmp5 = (_this2->current == 2);
            		}
            		else {
HXLINE( 329)			_hx_tmp5 = true;
            		}
HXDLIN( 329)		if (_hx_tmp5) {
HXLINE( 329)			_hx_tmp4 = ::flixel::math::FlxMath_obj::mouseInFlxRect(false,this->_bounds);
            		}
            		else {
HXLINE( 329)			_hx_tmp4 = false;
            		}
HXDLIN( 329)		if (_hx_tmp4) {
HXLINE( 331)			this->updateValue();
            		}
HXLINE( 335)		bool _hx_tmp6;
HXDLIN( 335)		if (::hx::IsNotNull( this->varString )) {
HXLINE( 335)			_hx_tmp6 = ::hx::IsNotNull( ::Reflect_obj::getProperty(this->_object,this->varString) );
            		}
            		else {
HXLINE( 335)			_hx_tmp6 = false;
            		}
HXDLIN( 335)		if (_hx_tmp6) {
HXLINE( 337)			this->value = ( (Float)(::Reflect_obj::getProperty(this->_object,this->varString)) );
            		}
HXLINE( 341)		Float _hx_tmp7 = this->handle->x;
HXDLIN( 341)		if ((_hx_tmp7 != this->get_expectedPos())) {
HXLINE( 343)			 ::flixel::FlxSprite _hx_tmp8 = this->handle;
HXDLIN( 343)			_hx_tmp8->set_x(this->get_expectedPos());
            		}
HXLINE( 347)		 ::flixel::text::FlxText _hx_tmp9 = this->valueLabel;
HXDLIN( 347)		_hx_tmp9->set_text(::Std_obj::string(::flixel::math::FlxMath_obj::roundDecimal(this->value,this->decimals)));
...
HXDLIN( 483)					_this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/addons/ui/FlxSlider.hx",9d,0a,7a,92),483,HX_("flixel.addons.ui.FlxSlider",c2,8c,47,0b),HX_("set_varString",fb,d8,20,b8)));
            				}
