...
HXLINE(1519)		if (::hx::IsNotNull( this->_currentTouch )) {
HXLINE(1521)			this->updatePointerDrag(this->_currentTouch,elapsed);
HXLINE(1523)			bool _hx_tmp;
HXDLIN(1523)			if (::hx::IsEq( this->_lastTouchX,this->_currentTouch->x )) {
HXLINE(1523)				_hx_tmp = ::hx::IsNotEq( this->_lastTouchY,this->_currentTouch->y );
            			}
            			else {
HXLINE(1523)				_hx_tmp = true;
            			}
HXDLIN(1523)			if (_hx_tmp) {
HXLINE(1525)				this->updatePointerMove(this->_currentTouch);
HXLINE(1526)				this->_lastTouchX = this->_currentTouch->x;
HXLINE(1527)				this->_lastTouchY = this->_currentTouch->y;
            			}
HXLINE(1530)			 ::flixel::input::FlxInput _this = this->_currentTouch->input;
HXDLIN(1530)			bool _hx_tmp1;
HXDLIN(1530)			if ((_this->current != 0)) {
HXLINE(1530)				_hx_tmp1 = (_this->current == -1);
            			}
            			else {
HXLINE(1530)				_hx_tmp1 = true;
            			}
HXDLIN(1530)			if (_hx_tmp1) {
HXLINE(1532)				this->updatePointerRelease(this->_currentTouch);
HXLINE(1533)				this->_currentTouch = null();
HXLINE(1534)				this->_lastTouchY = (this->_lastTouchX = null());
            			}
            		}
HXLINE(1538)		bool pressedElsewhere = false;
HXLINE(1539)		{
HXLINE(1539)			int _g = 0;
HXDLIN(1539)			::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::touches->list;
HXDLIN(1539)			while((_g < _g1->length)){
HXLINE(1539)				 ::flixel::input::touch::FlxTouch touch = _g1->__get(_g).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN(1539)				_g = (_g + 1);
HXLINE(1541)				if (this->checkPointerOverlap(touch)) {
HXLINE(1543)					overlap = true;
HXLINE(1544)					bool _hx_tmp2;
HXDLIN(1544)					if ((touch->input->current == 2)) {
HXLINE(1544)						_hx_tmp2 = this->selectable;
            					}
            					else {
HXLINE(1544)						_hx_tmp2 = false;
            					}
HXDLIN(1544)					if (_hx_tmp2) {
HXLINE(1546)						this->_currentTouch = touch;
HXLINE(1547)						this->_lastTouchX = touch->x;
HXLINE(1548)						this->_lastTouchY = touch->y;
HXLINE(1549)						this->updatePointerPress(touch);
            					}
HXLINE(1551)					goto _hx_goto_51;
            				}
            				else {
HXLINE(1553)					if ((touch->input->current == 2)) {
HXLINE(1555)						pressedElsewhere = true;
HXLINE(1556)						this->_lastPressTime = 0;
            					}
            				}
            			}
            			_hx_goto_51:;
            		}
HXLINE(1559)		bool _hx_tmp3;
HXDLIN(1559)		bool _hx_tmp4;
HXDLIN(1559)		if (pressedElsewhere) {
HXLINE(1559)			_hx_tmp4 = ::hx::IsNull( this->_currentTouch );
            		}
            		else {
HXLINE(1559)			_hx_tmp4 = false;
            		}
HXDLIN(1559)		if (_hx_tmp4) {
HXLINE(1559)			_hx_tmp3 = !(this->_justGainedFocus);
            		}
            		else {
HXLINE(1559)			_hx_tmp3 = false;
            		}
HXDLIN(1559)		if (_hx_tmp3) {
HXLINE(1561)			this->endFocus();
            		}
